  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51OkBi8IQxFBik99hIYqBigXFJ17t5xDnJaG9tMgeM4b8yg664HmAjO0YImaB9WxojuX03ACi9ALmbnKL3lDkHBNc00Q0uIx29S'); // 1) get checkout session from api
          _context.next = 4;
          return (0, _axios.default)({
            url: "http://127.0.0.1:3000/api/v1/bookings/getCheckoutSession/".concat(tourId)
          });
        case 4:
